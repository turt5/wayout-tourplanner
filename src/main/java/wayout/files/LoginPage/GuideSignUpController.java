...
public class GuideSignUpController extends TemporaryData implements Initializable {
    @FXML
    ...
    void backButtonClicked(ActionEvent event) throws Exception {
        root= FXMLLoader.load(GuideSignUpController.class.getResource("guideLogin.fxml"));
    ...
    void signUPClicked(ActionEvent event) throws IOException {
                ...
                if ((a1 != null) && (a2 != null) && (a3 != null) && (a5 != null) && (a6 != null && a6.equals(a7))){
                    ...
                    generated_code=""+sixLengthRandomNumber;
                        ...
                        GuideEmailVerifier emailVerifier=new GuideEmailVerifier();
